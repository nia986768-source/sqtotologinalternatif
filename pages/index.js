...
const D = {
  brand: 'SQTOTO',
  domain: 'sqtotologinalternatif.com',
  ...
  amphtml: 'sqtotologinalternatif.com',
};
...
export default function Home() {
  ...
  return (
    <>
      <Head>
        <title>SQTOTO : Portal Alternatif Login | Markas Besar Pasukan Pencari Hoki</title>
        <meta name="description" content="SQTOTO menyediakan login dan daftar resmi terpercaya. Link alternatif selalu aktif, akses cepat, dan layanan pelanggan 24 jam." />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <link rel="icon" href={D.logo} />
        <link rel="canonical" href={'https://' + D.domain + '/'} />
        <link rel="amphtml" href={'https://' + D.domain + '/amp/'} />
        <meta property="og:title" content="SQTOTO : Portal Alternatif Login | Markas Besar Pasukan Pencari Hoki" />
        <meta property="og:description" content="SQTOTO menyediakan login dan daftar resmi terpercaya. Link alternatif selalu aktif, akses cepat, dan layanan pelanggan 24 jam." />
        <meta property="og:image" content={D.logo} />
        <meta property="og:url" content={'https://' + D.domain} />
        <meta property="og:type" content="website" />
        <meta name="twitter:card" content="summary" />
        <meta name="twitter:title" content="SQTOTO : Portal Alternatif Login | Markas Besar Pasukan Pencari Hoki" />
        <meta name="twitter:description" content="SQTOTO menyediakan login dan daftar resmi terpercaya. Link alternatif selalu aktif, akses cepat, dan layanan pelanggan 24 jam." />
      ...
      <style jsx global>{`
        :root{--bg:#fafafa;--bg2:#f0f0f0;--card:#fff;--primary:#111;--primary2:#333;--accent:#666;--text:#111;--muted:#666;--border:rgba(0,0,0,.06);--r:8px}
        *{box-sizing:border-box;margin:0;padding:0}html{scroll-behavior:smooth}
        body{font-family:'Space Grotesk',sans-serif;background:var(--bg);color:var(--text);line-height:1.7;overflow-x:hidden}
        a{color:inherit;text-decoration:none}img{max-width:100%;display:block}
        .C{max-width:1140px;margin:0 auto;padding:0 20px}
        header{position:sticky;top:0;z-index:50;background:#fafafaf0;backdrop-filter:blur(14px);border-bottom:1px solid var(--border)}
        ...
        .bp{background:var(--primary);color:#fff;box-shadow:0 4px 16px #11135}
        .bp:hover{background:var(--primary2);transform:translateY(-2px);box-shadow:0 6px 24px #11150}
        ...
        .badge{display:inline-flex;align-items:center;gap:8px;padding:6px 16px;border:1px solid var(--border);border-radius:99px;font-size:12px;color:var(--primary);background:#11110;margin-bottom:20px;font-weight:600}
        ...
        .bnr-card:hover{transform:translateY(-3px);box-shadow:0 8px 24px #11120}
        ...
        .sh .tg{display:inline-block;padding:5px 14px;border:1px solid var(--border);border-radius:var(--r);font-size:11px;color:var(--primary);background:#11108;margin-bottom:10px;font-weight:700;text-transform:uppercase;letter-spacing:1px}
        ...
        .fc:hover{transform:translateY(-4px);border-color:var(--primary);box-shadow:0 10px 30px #11115}
        .fc .ic{width:48px;height:48px;border-radius:var(--r);background:#11112;display:flex;align-items:center;justify-content:center;font-size:22px;margin-bottom:12px}
        ...
        .cta .b{background:#fafafa;color:var(--primary)}
        ...
        .hero{background:#fff;padding:100px 0 70px}.hero h1{font-size:clamp(28px,4vw,48px)}.bp{background:#111;color:#fff;border-radius:99px}.bo{border-radius:99px}.fc{border:none;box-shadow:0 1px 3px rgba(0,0,0,.06)}.badge{background:#111;color:#fff;border:none;border-radius:99px}
      `}</style>
      ...
      <main>
        <section className="hero"><div className="C">
          ...
          <h1>SQTOTO : Portal Alternatif Login | Markas Besar Pasukan Pencari Hoki</h1>
        ...
        <section className="bnr"><div className="C">
          <div className="bnr-grid">
            <a href={D.linkDaftar} className="bnr-card"><img src="https://images.unsplash.com/photo-1519389950473-47ba0277781c?w=720&h=280&fit=crop" alt="SQTOTO - Promo 1" loading="lazy" /></a>
            <a href={D.linkDaftar} className="bnr-card"><img src="https://images.unsplash.com/photo-1531297484001-80022131f5a1?w=720&h=280&fit=crop" alt="SQTOTO - Promo 2" loading="lazy" /></a>
            <a href={D.linkDaftar} className="bnr-card"><img src="https://images.unsplash.com/photo-1550751827-4bd374c3f58b?w=720&h=280&fit=crop" alt="SQTOTO - Promo 3" loading="lazy" /></a>
          </div>
        </div></section>
        ...
        <section className="sec" id="tentang"><div className="C">
          ...
          <div className="art">
            <p>SQTOTO di situs resmi SQTOTO menghadirkan solusi akses digital yang inovatif dan efisien. Dibangun dengan teknologi terkini, platform SQTOTO menawarkan kecepatan loading yang superior, antarmuka minimalis yang intuitif, dan sistem keamanan mutakhir. Setiap komponen dioptimasi untuk memberikan pengalaman pengguna terbaik tanpa kompromi.</p>
            <p>Inovasi teknologi di SQTOTO melalui situs resmi SQTOTO mencakup enkripsi SSL 256-bit, arsitektur server terdistribusi dengan uptime 99,9%, dan sistem link alternatif otomatis. Platform kami mendukung semua browser dan perangkat modern, memastikan aksesibilitas universal. Tim engineering kami bekerja 24/7 untuk menjaga stabilitas dan keamanan sistem bagi seluruh pengguna.</p>
          </div>
        </div></section>
